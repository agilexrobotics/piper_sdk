...
|`MotorAngleLimitMaxSpdSet`|Ctrl Method|Set the angle limit and maximum speed for the motor.|Called from outside the class|`motor_num (int)`, `max_angle_limit (float)`, `min_angle_limit (float)`, `max_joint_spd (float)`|None|
