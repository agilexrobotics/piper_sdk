...
|`GetFK`|Getter Method|获取机械臂每个关节的正解,XYZ单位为mm,RXRYRZ单位为度，反馈长度为6的float类型数据列表,代表 1-6 关节相对 base_link 的位姿|obj.GetFK()|None|self.__link_fk|
...
|`__UpdatePiperFK`|Getter Method|更新piper正解数据|类内使用|None|None|
