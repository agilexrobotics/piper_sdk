...
|使用pyQT5的开源UI|[Piper_SDK_UI]<https://github.com/HoranTian/Piper_SDK_UI.git>|
...
- sdk的interface在创建实例后会检测是否激活自带的can模块，如果是其它can设备，可以将第二个形参设定为False，如：`piper = C_PiperInterface("can0",False)`
