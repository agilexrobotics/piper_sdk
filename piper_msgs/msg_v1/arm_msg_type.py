...
class ArmMsgType(Enum):
    ...
    PiperMsgEndPoseFeedback_X_Y = auto() #机械臂末端位姿反馈1
    PiperMsgEndPoseFeedback_Z_RX = auto() #机械臂末端位姿反馈2
    PiperMsgEndPoseFeedback_RY_RZ = auto() #机械臂末端位姿反馈3
    ...
    PiperMsgHighSpdFeed_MOTOR1 = auto()
    PiperMsgHighSpdFeed_MOTOR2 = auto()
    PiperMsgHighSpdFeed_MOTOR3 = auto()
    PiperMsgHighSpdFeed_MOTOR4 = auto()
    PiperMsgHighSpdFeed_MOTOR5 = auto()
    PiperMsgHighSpdFeed_MOTOR6 = auto()
    PiperMsgLowSpdFeed_MOTOR1 = auto()
    PiperMsgLowSpdFeed_MOTOR2 = auto()
    PiperMsgLowSpdFeed_MOTOR3 = auto()
    PiperMsgLowSpdFeed_MOTOR4 = auto()
    PiperMsgLowSpdFeed_MOTOR5 = auto()
    PiperMsgLowSpdFeed_MOTOR6 = auto()
    # transmit
