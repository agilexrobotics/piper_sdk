...
class CanIDPiper(Enum):
    ...
    ARM_END_POSE_FEEDBACK_X_Y = 0x2A2     #机械臂末端姿态反馈
    ARM_END_POSE_FEEDBACK_Z_RX = 0x2A3
    ARM_END_POSE_FEEDBACK_RY_RZ = 0x2A4
    ...
    ARM_INFO_HIGH_SPD_FEEDBACK_MOTOR1 = 0x251
    ARM_INFO_HIGH_SPD_FEEDBACK_MOTOR2 = 0x252
    ARM_INFO_HIGH_SPD_FEEDBACK_MOTOR3 = 0x253
    ARM_INFO_HIGH_SPD_FEEDBACK_MOTOR4 = 0x254
    ARM_INFO_HIGH_SPD_FEEDBACK_MOTOR5 = 0x255
    ARM_INFO_HIGH_SPD_FEEDBACK_MOTOR6 = 0x256
    #驱动器信息低速反馈，节点ID 0x1~0x6
    ARM_INFO_LOW_SPD_FEEDBACK_MOTOR1 = 0x261
    ARM_INFO_LOW_SPD_FEEDBACK_MOTOR2 = 0x262
    ARM_INFO_LOW_SPD_FEEDBACK_MOTOR3 = 0x263
    ARM_INFO_LOW_SPD_FEEDBACK_MOTOR4 = 0x264
    ARM_INFO_LOW_SPD_FEEDBACK_MOTOR5 = 0x265
    ARM_INFO_LOW_SPD_FEEDBACK_MOTOR6 = 0x266
    #CAN 升级总线静默模式设定指令
