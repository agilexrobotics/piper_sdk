...
class PiperMessage_V3(PiperMessage):
    ...
    def __init__(self, 
                ...
                #  1.8-8
                 arm_ik_joint_feedback:ArmMsgFeedBackIKJointStates=None,
        ...
        # ik 关节消息
        self.arm_ik_joint_feedback = arm_ik_joint_feedback if arm_ik_joint_feedback else ArmMsgFeedBackIKJointStates()
        # 夹爪控制
