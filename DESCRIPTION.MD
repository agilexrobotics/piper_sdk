...
- Use `C_PiperInterface_V3` for firmware version `1.8-8` and later. If an older example uses `C_PiperInterface`, replace it with `C_PiperInterface_V3` when running on V3 firmware/protocol.
