...
- 增加can封装文件`can_encapsulation.py`与sdk版本对应的修订版本`can_encapsulation_v0_3_2.py`，类内部增加了enum来作为can函数执行后的状态反馈，并为此修改了`hardware_port`的`__init__.py`以及interface中导入`C_STD_CAN`的方式
